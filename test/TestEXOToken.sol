...
contract TestEXOToken {
    ...
    function testInitialParametersUsingDeployedContract() public {
        ...
        Assert.equal(deployedExo.totalSupply(), 100000000, "The total supply of EXO should be 100000000");
        Assert.equal(deployedExo.airdropCarrier(), 0, "The address of airdrop carrier should be 0");
        Assert.equal(deployedExo.airdropAmount(), 10, "The airdrop amount of EXO per account should be 10");
        Assert.equal(deployedExo.minBalanceAfterAirdrop(), 50000000, "The minimum balance after airdrop should be 50000000");
    }

    function testInitialParametersWithNewEXOToken() public {
        Assert.equal(exo.totalSupply(), 100000000, "The total supply of EXO should be 100000000");
        Assert.equal(exo.airdropCarrier(), 0, "The address of airdrop carrier should be 0");
        Assert.equal(exo.airdropAmount(), 10, "The airdrop amount of EXO per account should be 10");
        Assert.equal(exo.minBalanceAfterAirdrop(), 50000000, "The minimum balance after airdrop should be 50000000");
    }

    function testAirdropWithOwnerAsCarrierAndRecipient() public {
        uint256 expectedOwnerBalance = 99999990;
        uint256 expectedStakeBalance = 10;
    ...
    function testDepositStakeWithZeroInterest() public {
        uint256 expectedBalance = 99999940;
        uint256 expectedStakeBalance = 50;
    ...
    function testWithdrawStakeWithZeroInterest() public {
        uint256 expectedBalance = 99999970;
        uint256 expectedStakeBalance = 20;
